            ...
            <div id="content" style="padding-bottom: 5%">
                ...
                <div class="card ggg">
                    <div class="card-body tes">
                        <h3 id="deh" class="card-title tit">Black Friday</h3>
                        <p class="card-text">
                ...
                <div class="row rex">
                    <div class="card boh">
                        <div class="card-body pad">
                            <h5 class="card-title tit">Web Push Notifications</h5>
                            ...
                            <div href="#" id="but2" class="btn btn-primary">KEEP ME UPDATE</div>
                        </div>
                    </div>
                    <div class="card boh" style="padding-right: 2%">
                        <div class="card-body pad">
                            <h5 class="card-title tit">Newsletter</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <div class="div-row">
                                <div class="col-auto">
